package com.challange.hilt.mockwebserver


import com.challange.hilt.utils.MockResponses
...
class MockDispatcher : Dispatcher() {
    ...
    private fun describeMismatch(
        mismatchDescription: StringDescription,
        requestMatcher: Matcher<in RecordedRequest>,
        request: RecordedRequest
    ) {
        mismatchDescription
            .appendText("\n--> Matcher:\n")
    ...
    private fun notFoundError(request: RecordedRequest) = MockResponse()
        .setBody(MockResponses.notFoundError.replace("__requestPlaceholder__", request.toString()))
