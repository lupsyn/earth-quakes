...
import com.challange.hilt.bdd.matchers.RecyclerViewMatcher.Companion.withRecyclerView
...
object RecyclerViewAssertions {
    ...
    fun assertRecyclerViewMatchersInPositions(
        @IdRes recyclerViewId: Int,
        matchersList: List<Pair<Int, Matcher<View>>>
    ) {
    ...
    private fun assertRecyclerViewMatcherInPosition(
        @IdRes recyclerViewId: Int,
        position: Int,
